                                        ...
                                        <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                            {
                                                users.map(user => <tr key={user._id}>
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-800">{/* Open the modal using document.getElementById('ID').showModal() method */}
                                                        <button className="btn" onClick={() => document.getElementById('my_modal_5').showModal()}><FcViewDetails /></button>
